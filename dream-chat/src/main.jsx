...
setMessages((current) => [...current, { id: `stopped-${Date.now()}`, role: "system", content: "Generation stopped by host action.", provider: "host", time: formatTime(), stopped: true }]);
  ...
  function renderChat() {
    ...
    // Stable identity so memoized TranscriptMessageRow props stay equal across
    // renders (retryLastMessage itself is re-created per render).
